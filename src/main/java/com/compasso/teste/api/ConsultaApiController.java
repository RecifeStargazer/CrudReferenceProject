...
public class ConsultaApiController implements ConsultaApi {
	...
	@Override
	@RequestMapping(value = "/consulta/{nome_cidade}/buscarListaCidadesPorNome", produces = {
	...
	@Override
	@RequestMapping(value = "/consulta/{id_cliente}/buscarClientePorId", produces = { "application/json" }, consumes = {
	...
	@Override
	@RequestMapping(value = "/consulta/{nome_estado}/buscarListaCidadesPorEstado", produces = {
			"application/json" }, consumes = { "application/json" }, method = RequestMethod.GET)
	...
	@Override
	@RequestMapping(value = "/consulta/{nome_cliente}/buscarListaClientePorNome", produces = {
			"application/json" }, consumes = { "application/json" }, method = RequestMethod.GET)
